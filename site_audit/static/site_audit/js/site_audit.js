...
function replace_fun(e) {
  return  e && e.replace("ms", "").replace("s", "").replace(",", "");
}
...
//   $(".warningScore .ScoreValueWarning").text(serverAndSecurityScoreWarningValue);
...
$(document).on("click", "#commonSeoIssuesList", function () {
  ...
  $(".progress-bar.bg-red").css({'width': `${commonSeoIssuesScoreFailedPercent}%`});
  $(".progress-bar.bg-yellow").css({'width': `${commonSeoIssuesScoreWarningPercent}%`});
  $(".progress-bar.bg-green").css({'width': `${commonSeoIssuesScorePassedPercent}%`});
  
  $(".progress-bar.red").css({'width': `${commonSeoIssuesScoreFailedPercent}%`});
  $(".progress-bar.yellow").css({'width': `${commonSeoIssuesScoreWarningPercent}%`});
  $(".progress-bar.green").css({'width': `${commonSeoIssuesScorePassedPercent}%`});
});
...
$(document).on("click", "#speedOptimizationlist", function () {
  ...
  $(".progress-bar.bg-red").css({'width': `${speedOptimizationScoreFailedPercent}%`});
  $(".progress-bar.bg-yellow").css({'width': `${speedOptimizationScoreWarningPercent}%`});
  $(".progress-bar.bg-green").css({'width': `${speedOptimizationScorePassedPercent}%`});

  $(".progress-bar.red").css({'width': `${speedOptimizationScoreFailedPercent}%`});
  $(".progress-bar.yellow").css({'width': `${speedOptimizationScoreWarningPercent}%`});
  $(".progress-bar.green").css({'width': `${speedOptimizationScorePassedPercent}%`});
});
...
$(document).on("click", "#serverAndSecurity", function () {
  ...
  $(".progress-bar.bg-red").css({'width': `${serverAndSecurityScoreFailedPercent}%`});
  $(".progress-bar.bg-yellow").css({'width': `${serverAndSecurityScoreWarningPercent}%`});
  $(".progress-bar.bg-green").css({'width': `${serverAndSecurityScorePassedPercent}%`});
  
  $(".progress-bar.red").css({'width': `${serverAndSecurityScoreFailedPercent}%`});
  $(".progress-bar.yellow").css({'width': `${serverAndSecurityScoreWarningPercent}%`});
  $(".progress-bar.green").css({'width': `${serverAndSecurityScorePassedPercent}%`});
});
...
$(document).on("click", "#mobileUsability", function () {
  ...
  $(".progress-bar.bg-red").css({'width': `${mobileUsabilityScoreFailedPercent}%`});
  $(".progress-bar.bg-yellow").css({'width': `${mobileUsabilityScoreWarningPercent}%`});
  $(".progress-bar.bg-green").css({'width': `${mobileUsabilityScorePassedPercent}%`});
  
  $(".progress-bar.red").css({'width': `${mobileUsabilityScoreFailedPercent}%`});
  $(".progress-bar.yellow").css({'width': `${mobileUsabilityScoreWarningPercent}%`});
  $(".progress-bar.green").css({'width': `${mobileUsabilityScorePassedPercent}%`});
});
...
$(document).on("click", "#advancedSeo", function () {
  ...
  $(".progress-bar.bg-yellow").css({'width': `${advancedSeoScoreWarningPercent}%`});
  $(".progress-bar.bg-green").css({'width': `${advancedSeoScorePassedPercent}%`});

  $(".progress-bar.red").css({'width': `${advancedSeoScoreFailedPercent}%`});
$(".progress-bar.yellow").css({'width': `${advancedSeoScoreWarningPercent}%`});
$(".progress-bar.green").css({'width': `${advancedSeoScorePassedPercent}%`});
});
...
function UpdateBars() {
  ...
  var health =generalPassedScore === 0 && TotalScore === 0  ? undefined :  progressBarReturn(generalPassedScore, TotalScore);
  ...
  // console.log("helth",generalPassedScore, TotalScore )
  if (health !== "" ) {
    ...
    //  console.log("seo-health1", health)
...
function HandleResponse(response) {
    ...
    if (typeof resposnseDatavalue == "object" && resposnseDatavalue !== null) {
      if (
        ...
        if (
          ...
          // if (ScoreBracketVar == 'Passed') {
          //     AuditDescription = "<small>Congratulations! Your webpage's CSS resources are minified.</small>"
          //     ChangedScore = 'Passed'
          // } else if (ScoreBracketVar == 'Warning') {
          //     AuditDescription = "<small>Your webpage's Some CSS resources are minified.</small>"
          //     ChangedScore = 'Warning'
          // } else if (ScoreBracketVar == 'Failed') {
          //     AuditDescription = "<small>Your webpage's CSS resources are not minified.</small>"
          //     ChangedScore = 'Failed'
          // }
        ...
        //       $.each(FilterSpeedOptimizationIssue,function(index,value){

        //          $("#speedOptimization_").append('<li class="media" id=""><label class="mr-3" >'+value+'</label><div class="media-body"><label></label><p class="Description"></p></div></li><hr />')
        //          $('#speedOptimization').append(`<li class="list-item"><a href="#">${value}</a></li>`)
        // })
        // server and security start

        // advance seo  start

        // if(SubResponse['/Api']){
        // let ResponseKey = SubResponse["Api"];
        // var AuditTitle = "";
        // var AuditId = 'Api';
        // var AuditDescription = SubResponse['Api']['description'];
        // var AuditDescription= `<small>Your DNS server is not using an SPF record. SPF (Sender Policy Framework) allows administrators to specify which hosts are allowed to send mail from a given domain by creating a specific SPF record or TXT record in the Domain Name System (DNS). You can find more information about SPF records</small>`

        //     let value = 'SPF Records Test'
        //

        //     var ScoreBracketVar = GetScoreBracket(ResponseKey['score']);
        //      var UpdateScoreVar = UpdateScore(ResponseKey,'commonSeoIssues',AuditDescription,'',AuditId)

        //     $("#advanceSeo").append('<li class="media '+UpdateScoreVar+'" id="issue-'+AuditId+'"><label class="mr-3" >'+value+'</label><div class="media-body"><p class="Description">'+AuditDescription+'</p></div></li><hr />')

        //     // FilterAdvanceSeo = advanceSeo.filter(item => !ExcludeAdvanceSeoValues.includes(item));
        //     $('#advanceSeo_').append(`<li class="list-item `+UpdateScoreVar+`"><a href="#issue-`+AuditId+`">${value}</a></li>`)

        //    }
        //    else{
        // //   $.each(advanceSeo,function(index,value){
        // //     $("#advanceSeo").append('<li class="media" id=""><label class="mr-3" >'+value+'</label><div class="media-body"><label></label><p class="Description"></p></div></li><hr />')
        // //     $('#advanceSeo_').append(`<li class="list-item"><a href="#">${value}</a></li>`)
        // // })
        //    }

        //    $.each(FilterAdvanceSeo,function(index,value){
        //     $("#advanceSeo").append('<li class="media" id=""><label class="mr-3" >'+value+'</label><div class="media-body"><label></label><p class="Description"></p></div></li><hr />')
        //     $('#advanceSeo_').append(`<li class="list-item"><a href="#">${value}</a></li>`)
        // })
        // advance seo end
        ...
        // progressbars code by nasir start

        // alert(generalFailedScore)
        // progressbar code end by nasir
        UpdateBars();
      }
    }
  ...
  var seoWebObj = "";
  // website seo
  // console.log("resposnsewebsite_seo_data", resposnsewebsite_seo_data)
  for (var [resposnseDatakey, resposnseDatavalue] of Object.entries(
    resposnsewebsite_seo_data
  )) {
    if (typeof resposnseDatavalue == "object" && resposnseDatavalue !== null) {
      seoWebObj = resposnseDatavalue["pages"][0];
      // console.log("seoWebObj", seoWebObj)
  ...
  if (seoWebObj !== undefined && typeof seoWebObj == "object") {
    ...
    if (SubResponse["keywords"] == "" || SubResponse["keywords"]) {
      ...
      if ($("#KeywordsCountCloud").length > 0) {
        ...
        // set array of angles, by which words will be placed.angles([0])
    ...
    if (seoWebObj["warnings"] == "" || seoWebObj["warnings"]) {
      ...
      $(document).on("click", ".modalBtn.Warnings", function () {
        ...
        $("#ModalData").html(ImgTable);
        $("#Img_List").empty();
        // console.log("Respone", SubResponse)
...
// console.log("IIMG", imgSrc)
  ...
  $(".auditSummary").on("click", function () {
      ...
      document.querySelector('.status-preview-top').scrollIntoView({ 
        behavior: 'smooth',
      });
...
var audi_id = setInterval(bottomGraph,1000)
  ...
  // var project_id = $("#selectedDomain :selected").attr("data-id");
  $.ajax({
    method: "GET",
    url:
    ...
    success: function (res) {
      ...
      if (res && res.status === false) {
        ...
        $(".pages_crawled_circle").circleProgress({
          value: 0,
          size: 145,
          thickness: "9",
          fill: {
   ...
   $(".battery-spider-inner").find("span").html("-")
  } else {
        $(".analtics-section-spinner").hide()
        $(".main-spinner").hide()
        ...
        $.each(table3, function (i, val) {
          // console.log(Number(val.users),'con1')
          // console.log(Number(val.users).toFixed(1),'con1')
          ...
          Number_of_sessions_per_user_count = Number(val.sessionsPerUser).toFixed(1);
        });
user_count=100.0
new_user_count=40.0
// Charts
dashboardChartTwo(new_user_count, user_count)
        ...
        //  user_count =4000;
        //   new_user_count =222;
        //   session_count = 222123;
        //   Bounce_Rate = 312;
        //   Avg_Session_Duration = 3123;
        //   Pages_Session = 23123;
        //   Page_Views = 312312;
        //   Number_of_sessions_per_user_count = 23123;
        // console.log("val", table3);
        $("#usersCount").html("");
        // $("#usersCount").html(user_count);
        $("#newUsersCount").html("");
        // $("#newUsersCount").html(new_user_count);
        $("#usersSessions").html("");
        // $("#usersSessions").html(  Number(Number_of_sessions_per_user_count).toFixed(2)  );
        $("#pageViews").html("");
        ...
        // Pages_Session = 400;
        // Page_Views = 500;
        // Number_of_sessions_per_user_count = 34;
       ...
       showTooltips: true,
        ...
        const mych6 = new Chart(ctx6, {
         ...
         display: false //This will do the task
          ...
          //   datasets: [
          //     {
          //       data: [100, Pages_Session * 100],
          //       backgroundColor: ["#eee", "#fcab10"],
          //       borderColor: ["#fff", "#fff"],
          //     },
          //   ],
          // },
       ...
       showTooltips: true,
         ...
         display: false //This will do the task
          ...
          //   datasets: [
          //     {
          //       data: [100, Avg_Session_Duration],
          //       backgroundColor: ["#eee", "#75B765"],
          //       borderColor: ["#fff", "#fff"],
          //     },
          //   ],
          // },
        ...
        showTooltips: true,
         ...
         display: false //This will do the task
          ...
          //   datasets: [
          //     {
          //       data: [100, Number_of_sessions_per_user_count * 100],
          //       backgroundColor: ["#eee", "blue"],
          //       borderColor: ["#fff", "#fff"],
          //     },
          //   ],
          // },
...
function spider() {
  var spidr_move = $("#spider_img").attr("data-move");
  if (spidr_move !== undefined && spidr_move !== "") {
    let batteryOuter = document.querySelector(".battery-outer");

    let batterySpider = document.querySelector(".battery-spider-inner");
    let move = batterySpider.children[0].getAttribute("data-move");

    if (move < 60) {
      batterySpider.style.marginLeft = `${move}%`;
      batterySpider.children[1].innerHTML = `${move}%`;
    } else {
      batterySpider.style.marginLeft = `60%`;
      batterySpider.children[1].innerHTML = `${move}%`;
    }
    batterySpider.children[0].setAttribute(
      "src",
      "/static/site_audit/assets/spider-active.svg"
    );
  }
}
function dashboard(url) {
  ...
  $.ajax({
    type: "GET",
    //    url: "/site_audit/get_site_data/?project_id=1",accordionLink
    ...
    success: function (response) {
      ...
      if (response.status) {
        ...
        spider();
        if (
          percentage_count >= yellow_lower_range &&
          percentage_count <= yellow_upper_range
        ) {
          $(".mobile_chartt .status-btn").addClass("bg-yellow");

          $(".pages_crawled_circle").circleProgress({
            value: percentage_count / 100,
            size: 145,
            thickness: "9",
            fill: {
              color: "#ffc107",
          ...
          percentage_count >= red_lower_range &&
          percentage_count <= red_upper_range
        ) {
          $(".mobile_chartt .status-btn").addClass("bg-red");
          $(".pages_crawled_circle").circleProgress({
            value: percentage_count / 100,
            size: 145,
            thickness: "9",
          ...
          percentage_count >= green_lower_range &&
          percentage_count <= green_upper_range
        ) {
          $(".mobile_chartt .status-btn").addClass("bg-green");
          $(".pages_crawled_circle").circleProgress({
            value: percentage_count / 100,
            size: 145,
            thickness: "9",
        ...
        var redirect_count = response.dashboard_data.redirect;
        var broken_links_count = response.dashboard_data.broken_links;
        var missing_alt_count = response.dashboard_data.missing_alt;
        var slow_image_count = response.dashboard_data.slow_image;
        var missing_title_count = response.dashboard_data.missing_title;
        $("#broken_links_count").html("");
        $("#redirect_count").html("");
        $("#missing_alt_count").html("");
        $("#slow_image_count").html("");
        $("#missing_title_count").html("");
        if (broken_links_count > 0) {
          $("#broken_links_count").html(`${broken_links_count}`);
          $("#broken_links_count").css({color: "red"})
        } else {
          $("#broken_links_count").html("ok");
          $("#broken_links_count").css({color: "green"})
        }
        if (redirect_count > 0) {
          $("#redirect_count").html(`${redirect_count}`);
          $("#redirect_count").css({color: "red"})
        } else {
          $("#redirect_count").html("ok");
          $("#redirect_count").css({color: "green"})
        }
        if (missing_alt_count > 0) {
          $("#missing_alt_count").html(`${missing_alt_count}`);
          $("#missing_alt_count").css({color: "red"})
        } else {
          $("#missing_alt_count").html("ok");
          $("#missing_alt_count").css({color: "green"})
        }
        if (slow_image_count > 0) {
          $("#slow_image_count").html(`${slow_image_count}`);
          $("#slow_image_count").css({color: "red"})
        } else {
          $("#slow_image_count").html("ok");
          $("#slow_image_count").css({color: "green"})
        }
        if (missing_title_count > 0) {
          $("#missing_title_count").html(`${missing_title_count}`);
          $("#missing_title_count").css({color: "red"})
        } else {
          $("#missing_title_count").html("ok");
          $("#missing_title_count").css({color: "green"})
        }
        // $(".accordionLink").attr("href", url);
        // $(".accordionLink").html(url);
        var inner_pages = response.crawl_pages.inner_pages;
        $(document).ready(function () {
          $("#search").on("keyup", function () {
            var input_val = $(this).val().toLowerCase();
            $("#custom-tbody ").filter(function () {
              $(this).toggle(
                $(this).text().toLowerCase().indexOf(input_val) > -1
              );
            });
          });
        });
        ...
        $.each(inner_pages, function (i, val) {
         $('#accordionSummary').append(`
         <div class="custom-tbody" id="custom-tbody">
         <div class="row gy-md-0 gy-2">
            <div class="col-lg-4 text-elipses">
                <a href="${val.url}" class="font-12 url_append text-elipses" target="_blank" title="${val.url}">
                 ${val.url}
                </a>
            </div>
            <div class="col-lg-3">
                <p class="text-gray text-left mb-0 font-12 text-elipses text-capitalize titleTag "title="${val.page_title}">
                     ${val.page_title}
                </p>
            </div>
            <div class="col-lg-2">
                <p class="mb-0 text-gray">${val.found}</p>
            </div>
           <div class="col-lg-2">
                        <button  data-url="${val.url}" id="url_${i}" class="btn btn-primary text-capitalize d-flex align-items-center gap-2 cls" data-bs-toggle="modal" data-bs-target="#addToMyWebsite" style={{}}>
        ...
        // disable button
        $(".cls").each(function () {
          var url_attr = $(this).attr("data-url");
          var url_id = $(this).attr("id");
          $("#selectedDomain > option").each(function () {
            if (url_attr === $(this).val() || url_attr.replace(/\/$/, "") === $(this).val().replace(/\/$/, "")) {
              $(`#${url_id}`).addClass("disabled");
            }
          });
        });
        //  $('.cls').each(function(){
        //       $("#selectedDomain > option").each(function() {
        //          var url_attr = $(this).val();

        //       var com1 = new RegExp(url_attr)
        //         var com2 =  $('.cls').attr('data-url')

        //     if (com1.test(com2)) {
        //     var url_id =  $('.cls').attr('id')
        //          $(`#${url_id}`).addClass('disabled')

        //           console.log(url_attr,'url_attr',com2,'($(this).val()')
        //     }
        ...
        Object.entries(response.data).forEach(([key, value]) => {
          $("#ImgTypeList").append(
            `<li class="mb-2"><span class="font-8 me-1" style="color: ${colors[i]}">
            <i class="fa-solid fa-circle"></i></span><div class="font-14 text-gray imgName text-uppercase"> ${key}</div>
              <span class="border-btm"></span><span class="font-14 text-gray Image_Types">${value }</span> <div class="img_spinner1" style="display: none;">
        ...
        let sum = 0;
        sum = Object.values(response.data).reduce(
          (partialSum, a) => partialSum + a,
          0
        );
        $(".chartRelativeTwo").css({visibility: "visible"})
        $(".image-data").css("padding-top", 0)
        $("#imgCount").text(sum);
        $("#imagesCount_spinner").hide();
        $('#donutchart').remove();
        $('#donutchartTT').append(`<canvas id="donutchart" width="322" height="322" />`)
        var xValues = ["GIF", "PNG", "SVG", "JPEG", "WEBP", "OTHER"];
        var yValues = Object.values(response.data);
        var barColors = [ "#23c723", "#eb4335","#167ee6","#c41d7f", "#ff6843","#ffc107"];
...
function performanceFnc() {
  ...
  if (url !== undefined && url !== "") {
    ...
    $.ajax({
      ...
      dataType: "json", // expect html to be returned
      success: function (response) {
      // console.log("site data 1", response)
          ...
          if (response.status) {
            ...
            if (
              ...
              if (big_images_count > 0) {
                ...
                $("#big_images_count").css({color: "red"})
              } else {
                $("#big_images_count").html("ok");
                $("#big_images_count").css({color: "green"})
              }
                ...
                if (
                  ...
                  if (
                    ...
                    if (
                      ...
                      // console.log("desktop1",destop_web_performance)
                  ...
                  if (
                    ...
                    if (
                      ...
                      $('.m_health').removeClass('bord_bottom_avg');
                       ...
                       $('#mobile_radial').html('')
// console.log("mobile1", mobile_web_performance)
  ...
  $(".health_mobile_spinner").hide()
            ...
            if (response.status) {
              ...
              if (
                ...
                var speedIndex =
                  response.response_mobile.all_data.lighthouseResult.audits["speed-index"]["displayValue"];
                ...
                var fcp_convertedValue =
                  parseFloat(firstcontentfulpaint) * 1000;
              ...
              if (
                ...
                resposnseMobileData = response.response_mobile.all_data;
                var performance =response?.response_mobile?.all_data?.lighthouseResult?.categories?.performance?.score;
              ...
              Poor`
                ...
                if (p_ >= 0 && p_ <= 49) {
                  ...
                  $("#domain-title").append(`Currently <span class="domain-name">&nbsp;${finalUrl}&nbsp;</span> is categorized as <span class="strongTwo"> POOR </span> in <span id="failStatus" class="strongTwo">${failCount}</span> out of <span class="strongCore">6</span> Core Vitals tests`);
                } else if (p_ >= 50 && p_ <= 89) {
                  $("#domain-title").html("");
                  $("#mobile").addClass("text-warning");
                  $(mobile_speed_state).addClass("text-warning");

                  $(".domain-title").append(`Currently <span class="domain-name">&nbsp;${finalUrl}&nbsp;</span>is categorized as <span class="strongOne"> NEEDS IMPROVEMENT </span> in <span class="status-count strongOne" id="warnStatus">${warnCount}</span> out of <span class="strongCore">6</span> Core Vitals tests`);
                } else if (p_ >= 90) {
                  $("#domain-title").html("");

                  $("#domain-title").append(`Currently <span class="domain-name">&nbsp;${finalUrl}&nbsp;</span>passes all six of the Core Vitals tests. Congratulations! We will alert you if we detect any issues in the future.`);
                }
              }
              if (response.page_data_dict.site_map_url !== undefined) {
               ...
               if(sitemapTest == false) {
                ...
                $(".sitemap_colorr").css("color", "#75b765")
              ...
              $(".p_spinner").hide();
              if(response?.response_desktop?.all_data?.lighthouseResult?.audits["is-on-https"]?.score == 0 ){
                ...
                $('#ssl--cer').removeClass('btn-outline-success')
                 $('#ssl--cer').addClass('btn-outline-danger')
                  ...
                  $(".ssl-certificate").css({color: "#75b765"})
              ...
              if (
                ...
                var totalBlockTime =
                resposnseMobileData["lighthouseResult"] &&  resposnseMobileData["lighthouseResult"]["audits"] &&  resposnseMobileData["lighthouseResult"]["audits"][  "total-blocking-time" ].displayValue;
                var largestContenFullPaint =
                resposnseMobileData["lighthouseResult"] &&  resposnseMobileData["lighthouseResult"]["audits"] &&    resposnseMobileData["lighthouseResult"]["audits"][
                    "largest-contentful-paint"
                  ].displayValue;
                var cumulativeLayoutShift =
                resposnseMobileData["lighthouseResult"] &&  resposnseMobileData["lighthouseResult"]["audits"] &&    resposnseMobileData["lighthouseResult"]["audits"][
                ...
                // speed index
                $(tooltipTitle_si).removeClass(
                  "bg-dark-red,bg-green,bg-yellow"
                );
                if (
...
$(document).on("change", ".radio", function () {
 ...
 mobile_radial4?.destroy();
 mobile_radial5?.destroy();
 mobile_radial6?.destroy();
 ...
 desktop_radial_nodata2?.destroy()
  ...
  $("#advancedSeo .warning .ScoreValue").text(0);
  $("#advancedSeo .passed .ScoreValue").text(0);
  $("#domain-title_main").hide()
  $("#tb_loader_new").show()
  $("#tb_loader").show();
  $(".default-val").html("");
  $(".accordionSummary").hide()
  $(".tb_loader_bottom").show();
  $(".no-data").hide()
  $("#imagesCount_spinner").show();
 $("#missing_alt_count").html("")
 $("#broken_links_count").html("")
 $("#redirect_count").html("")
 $("#missing_title_count").html("")
 ...
 $(".image-data").css("padding-top", "600%")
  $("#imgCount1").text("-")
  $(".chartRelativeTwo").css({visibility: "hidden"})
  $(".pages_crawled_circle").circleProgress({
    value: 0,
    size: 145,
    thickness: "9",
  ...
  // $(".Image_Types").text("-")
  $("#donutchart2").html("")
  $(".status-btn").removeClass("bg-red")
  $(".status-btn").removeClass("bg-yellow")
  $(".status-btn").removeClass("bg-green")
  $("#percentage_count").html("-");
  $("#spider_img").attr("data-move", 0);
  $(".battery-spider-inner").css({marginLeft: "0"})
  $(".battery-spider-inner").find("span").empty()
  $(".positioned-btn ").hide();
  ...
  $("#dashboard-chart").hide()
  $('#accordionSummary').html('')
  $("#big_images_count_loader").show();
  $("#big_images_count").hide();
  $("#pages_circle").hide();
  $(".rangeSliderMain").hide();
  $("#mainChart").show();
  $(".p_spinner_cls").hide();
  $(".crawl-spinner").show();
  $("#broken").html("-");
...
// ];
// var xValues = ["New Users", "Returning Users"];
// var yValues = [ Math.round(new_user_count),Math.round(user_count-new_user_count)];
...
dashboardChartTwo(new_user_count, user_count)
  ...
  $.ajax({
    ...
    beforeSend: function(){
      $("#slowImg_loader").show()
      $("#redirect_loader").show()
      $("#missingTitle_loader").show()
      $("#big_images_count_loader").show()
      $("#missingalt_loader").show()
    },
    success: function (response) {
      $("#slowImg_loader").hide()
      $("#redirect_loader").hide()
      $("#missingTitle_loader").hide()
      $("#big_images_count_loader").hide()
      $("#missingalt_loader").hide()
  ...
  $("#overview_spinner").show();
  $(".percent_spinner").show();
  $("#scoreDonutChart").html("");
  si.html("");
  tbt.html("");
  lcp.html("");
 ...
 $(".ssl-certificate").css({color: "black"})
  ...
  $.ajax({
    ...
    dataType: "json", // expect html to be returned
    success: function (response) {
      // console.log("site data 2", response)
      if (response) { 
        ...
        if (response.status) {
          ...
          if (
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    // console.log("desktop2", destop_web_performance)
                    if(destop_web_performance !== undefined){
                      if (
                        destop_web_performance >= yellow_lower_range &&
                        destop_web_performance <= yellow_upper_range
            ...
            $(".mobile_chart .box").removeClass("yellow");
            $(".mobile_chart .status-btn").removeClass("bg-yellow");
            $(".mobile_chart .status-btn").text(" ");
            $(".mobile_text").removeClass("text-yellow");

            $(".mobile_chart .box").removeClass("red");
            $(".mobile_chart .status-btn").removeClass("bg-red");
            $(".mobile_chart .status-btn").text(" ");
            $(".mobile_text").removeClass("text-red");

            $(".mobile_chart .box").removeClass("green");
            $(".mobile_chart .status-btn").removeClass("bg-green");
            $(".mobile_chart .status-btn").text(" ");
              ...
              if (
                ...
                if (
                 ...
                 if (
                      ...
                      //  console.log("mobile2",mobile_web_performance )
                       if(mobile_web_performance !== undefined){
                        if (
                          mobile_web_performance >= yellow_lower_range &&
                          mobile_web_performance <= yellow_upper_range
            ...
            if (
              ...
              $.each(data, function (i, val) {
                var offSet =
                  (100 * val.convertedValue) /
                  (2 * val.lowerRange +
                    (val.upperRange - val.lowerRange));
                $(".indicator_" + i).css("left", offSet >= 100 ? "98%": offSet <= 0 ? "1%": `${offSet}%`
                );

                $(".percentage_" + i).html(offSet >= 100 ? "98%" : offSet.toFixed(1) <= 0 ? "1%": `${offSet.toFixed(1)}%`
                );
              });
        ...
        `);
            ...
            if (
              ...
              // console.log(resposnseMobileData['lighthouseResult']['audits']['speed-index'].displayValue,'resposnseMobileData')
              var speedIndex =
                response.response_mobile.all_data.lighthouseResult.audits["speed-index"
                ]["displayValue"];
              ...
              // speed index
              $(".indicator").removeClass("bg-dark-red");
              $(".indicator").removeClass("bg-green");
              ...
              if (
                ...
                $(tooltipTitle_tbt).attr("title", `${totalBlockTime} ms`);
                $(tooltipTitle_tbt).addClass("bg-yellow");
              } else if (totalBlockTime > tbt_upperRange) {
                failCount++;
                $(tbt_status).append(poorScore);
                $(tbt_status).css("color", poorColor);
