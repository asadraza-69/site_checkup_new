      ...
      if (
        ...
        if (SubResponse.length > 0) {
          ...
          $.each(SubResponse, function (index, val) {
            BrokenLinksHtml +=
              "<li class='mb-2 px-1 py-1' style='background: #dde2e3ad'><a href=" + val + " target='_blank'>" + val + "</a></li> <div class='border_bottom_modal mb-2'> </div>";
          });
    ...
    if (typeof resposnseDatavalue == "object" && resposnseDatavalue !== null) {
      if (
        ...
        if (
          ...
          $('#seoHdg_spinner').hide();
          var finalUrll= $("#selectedDomain :selected").text().replace("https://", "").replace("http://", "")
              ...
              for (const [key, value] of Object.entries(ErrorItems)) {
                if (value["sourceLocation"] !== undefined) {
                  ErrorsInConsole +=
                    ...
                    "</a>";
                  ErrorsInConsole +=
                    "<code>" + value["description"] + "</code></li> <div class='border_bottom_modal mb-3'> </div>";
                } else {
                  ErrorsInConsole +=
                    "<li class='px-2><code>" + value["description"] + "</code></li> <div class='border_bottom_modal mb-3'> </div>";
                }
              }
              ErrorsInConsole += "</ul> ";
            }
               ...
               $("#coreVitalsShow").show()
                      ...
                      if (
                        ...
                        if (
                          ...
                          if (
                            ...
                            $("#desktop_icon").html('');
                            $("#desktop_icon").html("<i class='fa fa-desktop fa-2x'></i>")
                            $(".health_Desktop_spinner").hide()
                      ...
                      if (
                        ...
                        if (
                          ...
                          if (
                            ...
                            $(".mobile_chart .status-btn").addClass(
                              "bg-yellow"
                            );
                            ...
                            $("#mobile_icon").html("<i class='lni lni-mobile iconsize'></i>")
                ...
                if (response.status) {
                  ...
                  if (
                    ...
                    largestContenFullPaint = replace_fun(
                      largestContenFullPaint
                    );
              ...
              Poor`
                  ...
                  if (
                    ...
                    if (
                      ...
                      $(lcp_infoIconBackground).css(
                        "background",
                        goodIconColor
                      );
                      $('.lcp_bar').addClass('bg-light-green')
                      $(tooltipTitle_lcp).attr(
                        "title",
