...
var organizationSchemaMarkup =
    '<script type="application/ld+json">\n' +
    '{\n' +
    '   \"@context\": \"http://schema.org/\",\n' +
    '   \"@type\":\"#organizationType\",\n' +
    '   \"name\": \"#organizationName\",\n' +
    '   \"alternateName\": \"#organizationAltName\",\n' +
    '   \"url\": \"#Ourl\",\n' +
    '   \"logo\": \"#logourl\",\n' +
    '   \"contact\": \"#Ocontact\",\n' +
    '   \"sameAs\": [\n' +
...
var websiteSchemaMarkup =
    ...
    '      \"potentialAction\": {\n' +
    '      \"@type\": \"SearchAction\",\n' +
    '      \"target\": \"#websiteInternalUrl {search_term_string} #optionalString\"\n' +
...
var HowToSchemaMarkup =
    ...
    '   \"step\": [{\n' +
    '        \"@type\": \"HowToStep\",\n' +
    '        \"text\":\"#HStepInstruction\",\n' +
    '        \"image\":\"#HImageUrl\",\n' +
    '        \"name\":\"#HInstructionName\",\n' +
    '        \"url\":\"#HInstructionURL\"\n' +
    '    },\n' +
    '    {\n' +
    '        \"@type\": \"HowToStep\",\n' +
    '        \"text\":\"#HStepTwoInstruction\",\n' +
    '        \"image\":\"#HImageTwoUrl\",\n' +
    '        \"name\":\"#HInstructionTwoName\",\n' +
    '        \"url\":\"#HInstructionTwoURL\"\n' +
    '    },\n' +
    '    {\n' +
    '        \"@type\": \"HowToStep\",\n' +
    '        \"text\":\"#HStepThreeInstruction\",\n' +
    '        \"image\":\"#HImageThreeUrl\",\n' +
    '        \"name\":\"#HInstructionThreeName\",\n' +
    '        \"url\":\"#HInstructionThreeURL\"\n' +
    '    }\n' +
    '   ]\n' +
    '}\n' +
    '</script>';
...
var FAQSchemaMarkup =
    ...
    '       },{\n' +
    '       \"@type\": \"Question",\n' +
    '       \"name\":\"#threequestionsf\",\n' +
    '       \"acceptedAnswer": {\n' +
    '           \"@type\": \"Answer",\n' +
    '             \"text\": \"#threeqaAcceptAns\"\n' +
    '           }\n' +
    '   }]\n' +
    ' }\n' +
    '</script>';
...
var EventSchemaMarkup =
    ...
    '   \"eventAttendanceMode\":\"https://schema.org/#eventattendance\",\n' +
    '   \"location\":{\n' +
    '      \"@type\":\"Place\",\n' +
...
var JobPostingSchemaMarkup =
    ...
    '       }\n' +
    '     },\n' +
    '   \"responsibilities\":\"#Jresponsibilities\",\n' +
    '   \"skills\":\"#JSkills\",\n' +
    '   \"qualifications\":\"#JQualification\",\n' +
    '   \"educationRequirements\":\"#JEducationRequirment\",\n' +
    '   \"experienceRequirements\":\"#JExperienceRequirment\"\n' +
    '}\n' +
    '</script>';
...
function ViewModelPage(schemas) {
    ...
    $(document).on("click", ".deleteJson", function () {
        $("#reset").modal('show')
    })

    $(document).on("click", "#reset_btn", function () {
        $("#reset").modal('hide')
        $(ttt.schemaItems).each(function (index, element) {
            let symbols = Object.getOwnPropertySymbols(element.value);
            let latestValueSymbol = symbols.find(s => s.toString() === "Symbol(_latestValue)");
            let latestValue = element.value[latestValueSymbol];
            latestValue = ''
            element.value[latestValueSymbol] = latestValue;
        });
    });
...
organizationType = ["Organization", "Airline", "Consortium", "Corporation", "EducationalOrganization", "FundingScheme", "GovernmentOrganization", "LibrarySystem", "MedicalOrganization", "NGO", "NewsMediaOrganization", "PerformingGroup", "Project", "SportOrganization", "WorkersUnit"]

recipeCategory=['Eppetizer','Entree', 'Dessert'];

eventStatus=['Scheduled','Postponed','Cancelled','MovedOnline']

attendanceMode=['Online','Offline','Mixed']

performanceType=['Person','PerformingGroup','MusicGroup','DanceGroup', 'TheaterGroup']
...
schemas = [
    ...
    // Product[2]
    {
        title: 'Product', jsonld: PRDSchemaMarkup, schemaItems: [
            ...
            },
            {
                ...
                info: '<p>Various identification properties; these are described at <a href="http://schema.org/Product" target="_blank">schema.org/Product</a>. Google recommends including brand and at least one identifier for each product.</p><p>Google Structured testing pool won&#39;t validate unless there is an additional SKU field. This number is being used for MPN and SKU in the code</p>',
                property: 'gtin14',
                placeholder: 'Unique Gtin14 Number',
                title: 'Gtin14:',
                macro: '#gtin14',
                type: 'string'
            },
            ...
            },
            {
                ...
                info: '<p>Various identification properties; these are described at <a href="http://schema.org/Product" target="_blank">schema.org/Product</a>. Google recommends including brand and at least one identifier for each product.</p><p>Google Structured testing pool won&#39;t validate unless there is an additional SKU field. This number is being used for MPN and SKU in the code</p>',
                property: 'gtin18',
                placeholder: 'Unique Gtin18 Number',
                title: 'Gtin18:',
                macro: '#gtin18',
                type: 'string'
            },
    ...
    ,
    {
        title: 'Organization', jsonld: organizationSchemaMarkup, schemaItems: [

            {
                required: true,
                title: 'Organization Type: ',
                info: '<p>Organization objects must be based on one of the following schema.org types: </p>',
                property: 'schemaType',
                placeholder: 'schemaType',
                macro: '#organizationType',
                type: 'combo',
            ...
            },
            {
                ...
                info: 'The name of the person or organization.',
                property: 'name',
                placeholder: 'Your Alternate Name',
                macro: '#organizationAltName',
                type: 'string'
            },
            {
                required: true,
            ...
            },
            {
                ...
                info: 'social profile',
                property: 'socialProfileURL',
                placeholder: 'Social Profile URL',
                macro: '#socialProfileurl',
                type: 'string'
            },
            {
                required: true,
                title: 'Social Profile URL 2',
                info: 'social profile',
                property: 'socialProfileURL2',
                placeholder: 'Social Profile URL 2',
                macro: '#socialProfile2url',
                type: 'string'
            },
            {
                required: true,
                title: 'Social Profile URL 3',
                info: 'social profile',
                property: 'socialProfileURL3',
                placeholder: 'Social Profile URL 3',
                macro: '#socialProfile3url',
                type: 'string'
            },
    ...
    {
        title: 'Website', jsonld: websiteSchemaMarkup, schemaItems: [
            ...
            {
                required: true,
                title: 'Internal site search URL (e.g. https://example.com/search?q=):',
                info: 'A 2nd (optional) image that is representative of the article.',
                property: 'image',
                placeholder: 'Picture URL',
                macro: '#websiteInternalUrl',
                type: 'string'
            },
            {
                required: true,
                title: 'Optional: string in the search URL after the query:',
                info: 'job Title.',
                property: 'job Title',
                placeholder: 'job Title',
                macro: '#optionalString',
                type: 'string'
            },
    ...
    // How To [new]
    {
        title: 'How-to', jsonld: HowToSchemaMarkup, schemaItems: [
            {
                required: true,
                info: '<p> name.</p>',
                property: 'name ',
            ...
            {
                required: true,
                info: '<p>The total time it takes to. </p>',
                property: 'totalTime',
            ...
            {
                required: true,
                info: '<p>The estimation length of time it takes. </p>',
            ...
            {
                required: true,
                info: '<p>The current time it takes to.</p>',
            ...
            {
                required: true,
                info: '<p>Image of the completed.</p>',
                property: 'image.1 ',
                placeholder: 'Image 1 URL',
                title: 'Image 1 URL:',
                macro: '#HImage1Url',
            ...
            {
                required: true,
                info: '<p>2nd Image of the completed.</p>',
                property: 'image.2 ',
                placeholder: 'Image 2 URL',
                title: 'Image 2 URL:',
                macro: '#HImage2Url',
            ...
            {
                required: true,
                info: '<p>3rd Image of the completed.</p>',
                property: 'image.3 ',
                placeholder: 'Image 3 URL',
                title: 'Image 3 URL:',
                macro: '#HImage3Url',
              ...
              {
                required: true,
                info: '<p>Supply name.</p>',
                property: 'SupplyName',
                placeholder: 'Supply # 1',
                title: ' Supply # 1:',
                macro: '#HSupplyOneName',
                type: 'string'
            },
            {
                required: true,
            ...
            },
            {
                ...
                placeholder: 'Tool # 3',
                title: ' Tool # 3:',
                macro: '#HToolThreeName',
                type: 'string'
            },
            {
                required: true,
                info: '<p>The steps to make.</p>',
                property: 'stepInstructions',
                placeholder: 'Step # 1: Insturction',
                title: 'Step # 1: Insturction',
                macro: '#HStepInstruction',
                type: 'string'
            },
            {
                required: true,
                ...
                property: 'image',
                placeholder: 'Image URL',
                title: 'Step # 1:Image URL',
                macro: '#HImageUrl',
                type: 'string'
            },
            {
                required: true,
                info: '<p>instruction name.</p>',
                property: 'instructionName',
                placeholder: 'Name',
                title: 'Step # 1: Name',
                macro: '#HInstructionName',
                type: 'string'
            },
            {
                required: true,
                info: '<p>Instruction URL.</p>',
                property: 'instructionURL',
                placeholder: 'URL',
                title: 'Step # 1: URL',
                macro: '#HInstructionURL',
                type: 'string'
            },
            {
                required: true,
                info: '<p>The steps to make.</p>',
                property: 'stepInstructions',
                placeholder: 'Step # 2: Insturction',
                title: 'Step # 2: Insturction',
                macro: '#HStepTwoInstruction',
                type: 'string'
            },
            {
                required: true,
            ...
            },
            {
                ...
                info: '<p>The steps to make.</p>',
                property: 'stepInstructions',
                placeholder: 'Step # 3: Insturction',
                title: 'Step # 3: Insturction',
                macro: '#HStepThreeInstruction',
                type: 'string'
            },
            {
                required: true,
                ...
                property: 'image',
                placeholder: 'Image URL',
                title: 'Step # 3:Image URL',
                macro: '#HImageThreeUrl',
                type: 'string'
            },
            {
                required: true,
  ...
  
    {
        title: 'Event', jsonld: EventSchemaMarkup, schemaItems: [
            ...
            {
                required: true,
                info: '<p> Event Attendance </p>',
                property: 'Attendance',
                placeholder: 'Event Attendance',
                title: 'Event Attendance:',
                macro: '#eventattendance',
                type: 'combo',
                choices: attendanceMode,
            },
            ...
            {
                required: true,
                info: '<p>The performer&#39;s type</p>',
                property: 'performer.type',
                placeholder: 'Performers Type',
                title: 'Performers Type: ',
                macro: '#performinggroup',
                type: 'combo',
                choices: performanceType
            }
            ,
            {
                required: true,
    ...
    //Job Posting [20]
    {
        title: 'Job Posting', jsonld: JobPostingSchemaMarkup, schemaItems: [
            ...
            {
                required: true,
                info: '<p> Responsibilities</p>',
                property: 'responsibilities',
                placeholder: 'Responsibilities',
                title: 'Responsibilities:',
                macro: '#Jresponsibilities',
                type: 'string'
            },
            {
                required: true,
            ...
            {
                required: true,
                info: '<p> Qualification</p>',
                property: 'Qualification',
                placeholder: 'Qualification',
                title: 'Qualification:',
                macro: '#JQualification',
                type: 'string'
            },
            {
                required: true,
                info: '<p> Education Requirment</p>',
                property: 'Education Requirment',
                placeholder: 'Education Requirment',
                title: 'Education Requirment:',
                macro: '#JEducationRequirment',
                type: 'string'
            },
            {
                required: true,
                info: '<p> Experience Requirment</p>',
                property: 'Experience Requirment',
                placeholder: 'Experience Requirment',
                title: 'Experience Requirment:',
                macro: '#JExperienceRequirment',
                type: 'string'
            },
        ]
    },
    ...
    // FAQ [21]
    {
        title: 'FAQ Page', jsonld: FAQSchemaMarkup, schemaItems: [
            {
                required: true,
                info: '<p>The full text of the short form of the question. For example, &#34;How many teaspoons in a cup?&#34;.</p>',
                property: 'name ',
            ...
            },
            {
                ...
                property: 'text ',
                placeholder: 'Accepted Answer Text',
                title: 'Accepted Answer Text 2',
                macro: '#twoqaAcceptAns',
                type: 'string'
            },
            {
                required: true,
            ...
            },
            {
                ...
                property: 'text ',
                placeholder: 'Accepted Answer Text',
                title: 'Accepted Answer Text 3',
                macro: '#threeqaAcceptAns',
                type: 'string'
            },
